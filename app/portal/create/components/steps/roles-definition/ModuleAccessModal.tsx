...
export default function ModuleAccessModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-sky-950/18 px-4 backdrop-blur-[2px]">
      <div className="flex max-h-[86vh] w-full max-w-5xl flex-col overflow-hidden rounded-[24px] border border-sky-100 bg-white shadow-[0_28px_100px_rgba(14,165,233,0.16)]">
